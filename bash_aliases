...
#alias codex='codex --profile m21'
alias dangerclaude='claude --allow-dangerously-skip-permissions'
alias gcm='git checkout main'

alias ghostty='$HOME/Downloads/Ghostty-1.3.1-x86_64.AppImage'
alias glamor='$HOME/glamoroustoolkit/bin/GlamorousToolkit'
